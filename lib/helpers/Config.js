export function config(env_var, default_value) {
    ...
    if (isLocalDev) {
        return (_c = (_b = window._env) === null || _b === void 0 ? void 0 : _b[`REACT_APP_${env_var}`]) !== null && _c !== void 0 ? _c : default_value;
    }
    if (typeof ((_d = window._env_cloud) === null || _d === void 0 ? void 0 : _d[connector]) !== 'object') {
